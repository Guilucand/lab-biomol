...
\title{Preparazione TAE e Restrizione del DNA \\ (Esercitazione n° 3)} % Title

\author{Litterini S. \\Giulio B. \\Cracco A.\\Buzzolan T. } % Author name

\date{16 Marzo 2018} % Date for the report
...
\centering
\includegraphics[width=0.6\textwidth]{elettroforesi.png}
...
\centering
\includegraphics[width=0.3\textwidth]{agarosio.jpg}
...
\centering
\includegraphics[width=0.3\textwidth]{vaschetta.jpg}
...
\centering
\includegraphics[width=0.3\textwidth]{caricamento.jpg}
...
\centering
\includegraphics[width=0.3\textwidth]{separazione.jpg}
...
\centering
\includegraphics[width=0.3\textwidth]{uv.jpg}
