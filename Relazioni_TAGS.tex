...
Questi strumenti sono:
		...
		\begin{figure}[H]
			...
			\caption{Serve per l'appunto per l'elettroforesi, tecnica per analizzare e separare acidi nucleici,
			sfruttando cariche presenti nelle molecole di DNA e RNA per farle migrare.}
